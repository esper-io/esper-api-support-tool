...
class EnhancedStatusBar(wx.StatusBar):
    ...
    def AddWidget(
        ...
        if horizontalalignment not in [
            ...
            raise '\nERROR: Parameter "horizontalalignment" Should Be One Of ' '"ESB_ALIGN_CENTER_HORIZONTAL", "ESB_ALIGN_LEFT", "ESB_ALIGN_RIGHT"' '"ESB_EXACT_FIT"'

        if verticalalignment not in [
            ESB_ALIGN_CENTER_VERTICAL,
            ESB_EXACT_FIT,
            ESB_ALIGN_TOP,
            ESB_ALIGN_BOTTOM,
        ]:
            raise '\nERROR: Parameter "verticalalignment" Should Be One Of ' '"ESB_ALIGN_CENTER_VERTICAL", "ESB_ALIGN_TOP", "ESB_ALIGN_BOTTOM"' '"ESB_EXACT_FIT"'
